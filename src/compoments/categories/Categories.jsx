import { Button, StyleSheet, Text, View, Image, TouchableOpacity, Dimensions, ScrollView, Platform } from 'react-native';
          ...
          if (index < 6 && category.name !== "all") {
            return (
              <TouchableOpacity 
                ...
                onPress={() => {
                  navigation.navigate('CategoriDetailPage', { categoryId: category._id });
                }}
              >
